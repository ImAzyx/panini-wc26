    ...
    <Link href={`/groups/${id}`} className="block group">
      <div className="border border-white/[0.07] hover:border-lime/20 rounded-xl p-4 bg-surface hover:bg-elevated transition-all">
        <div className="flex justify-between items-start mb-2.5">
          <h3 className="font-title font-bold text-base tracking-wide text-text group-hover:text-lime transition-colors">
            {name}
          </h3>
          <span className="text-[9px] font-mono text-text/30 bg-white/[0.04] border border-white/[0.06] px-2 py-0.5 rounded tracking-[0.2em] uppercase">
            {inviteCode}
          </span>
        </div>
