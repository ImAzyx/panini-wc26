    ...
    <main className="min-h-screen flex items-center justify-center p-4 relative overflow-hidden">
      ...
      <div className="absolute inset-0 pointer-events-none" aria-hidden>
        ...
        <div
          ...
          style={{
            background: "radial-gradient(ellipse, rgba(168,255,62,0.04) 0%, transparent 70%)",
          }}
        />
        <div
      ...
      <div className="w-full max-w-sm relative z-10">
        <div className="text-center mb-10">
          <div className="inline-flex items-center justify-center w-10 h-10 bg-lime rounded-xl mb-4">
            <span className="font-title font-bold text-void text-lg leading-none">P</span>
          </div>
          <h1 className="font-title font-bold text-4xl text-text tracking-[0.15em] uppercase">
            Panini <span className="text-lime">WC26</span>
          </h1>
          <p className="text-[9px] font-title font-semibold tracking-[0.2em] uppercase text-text/25 mt-1.5">
            FIFA World Cup 2026
          </p>
        </div>
        {children}
