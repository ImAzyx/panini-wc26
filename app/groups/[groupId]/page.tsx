    ...
    <main className="max-w-xl mx-auto px-4 py-5">
      <div className="flex justify-between items-start mb-6">
        ...
        <div className="text-right">
          <p className="text-[9px] font-title  uppercase text-text/28 mb-1">
            Code d&apos;invitation
          </p>
          <span className="text-sm font-mono font-bold text-lime/65 bg-lime/5 border border-lime/15 px-3 py-1 rounded-lg uppercase">
            {group.inviteCode}
          </span>
        </div>
      </div>
      ...
      <Link
        ...
        className="flex items-center justify-between w-full bg-lime/8 border border-lime/20 hover:bg-lime/12 hover:border-lime/35 text-lime font-title font-bold py-3.5 rounded-xl mb-6 px-5 transition-all text-sm  uppercase"
      >
